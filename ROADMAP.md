...
- **Fases seguintes, ainda não escopadas em detalhe**: abertura de empresas com fluxo de caixa, reputação, cenário isométrico animado, linha do tempo dos 18 anos à aposentadoria, e relatório de fim de temporada. Uma fase por vez, mesma disciplina das Fases 2A/2B/2C de identidade visual (RFC-008/010/011).
