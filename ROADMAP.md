...
- **Fases seguintes, ainda não escopadas em detalhe** (spec completa do usuário é maior que várias RFCs já feitas juntas): carreira multi-nível com educação como pré-requisito, catálogo completo de investimentos (Tesouro/CDB/LCI/FIIs/ETFs/Ações/Ouro/Bitcoin/Ethereum/Previdência) com conhecimento bloqueando acesso (reaproveitando o padrão de `js/progression.js`), mercado imobiliário, abertura de empresas com fluxo de caixa, sistema de luxo/status social, reputação, cenário isométrico animado, linha do tempo dos 18 anos à aposentadoria, e relatório de fim de temporada. Uma fase por vez, mesma disciplina das Fases 2A/2B/2C de identidade visual (RFC-008/010/011).
